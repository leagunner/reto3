...
botonAñadir.addEventListener('click', function(){  //Añadiendo funcion al boton
    ...
    if(tipoProducto.value == 1){ //comprobando el valor de la seleccion del tipo de producto
        ...
        let modelo = `<li class="list-group-item li-listado"><img src="images/viberes.png" alt="Viberes" id="logos"> <h4>${tituloProducto}</h4><a href="#" id="chulardi"><img src="images/chulardi.png" class="chulito" alt="Chulote" atributo-nombre="${tituloProducto}" atributo-detalles="${detallesProducto}"></a></li>` //agregando elemento a lista + link+ imagen+ titulo del producto hecho por el usuario + chulito
        ...
        document.addEventListener('click',function(e){
            if (e.target.className == "chulito"){                
                ...
                botonAdd.style.display = 'none'
                document.getElementById("imagen-detalles").src = "images/viberes.png"
    ...
    else if(tipoProducto.value == 2){ //comprobando el valor de la seleccion del tipo de producto
        let tituloProducto = `${nombreProducto.value}`
        let detallesProducto = `${descripcion.value}`
        let modelo = `<li class="list-group-item li-listado"><img src="images/lacteos.png" alt="Viberes" id="logos"> <h4>${tituloProducto}</h4><a href="#" id="chulardi"><img src="images/chulardi.png" class="chulito" alt="Chulote" atributo-nombre="${tituloProducto}" atributo-detalles="${detallesProducto}"></a></li>` //agregando elemento a lista + link+ imagen+ titulo del producto hecho por el usuario + chulito
        contenedorListado.innerHTML += modelo
        document.addEventListener('click',function(e){
            if (e.target.className == "chulito"){                
                contenedorListado.style.display = 'none'
                ...
                contenedorDetalles.style.display = 'block' //Mostrando el contenedor de los detalles
                botonAdd.style.display = 'none'
                document.getElementById("imagen-detalles").src = "images/lacteos.png"
                document.getElementById("h1-detalles").innerHTML = e.target.getAttribute("atributo-nombre")
                document.getElementById("p-detalles").innerHTML = e.target.getAttribute("atributo-detalles")
                document.getElementById('logo-cierre-detalles').addEventListener('click', function(){
                    contenedorDetalles.style.display = 'none'
    ...
    else if(tipoProducto.value == 3){ //comprobando el valor de la seleccion del tipo de producto
        let tituloProducto = `${nombreProducto.value}`
        let detallesProducto = `${descripcion.value}`
        let modelo = `<li class="list-group-item li-listado"><img src="images/verduras.png" alt="Viberes" id="logos"> <h4>${tituloProducto}</h4><a href="#" id="chulardi"><img src="images/chulardi.png" class="chulito" alt="Chulote" atributo-nombre="${tituloProducto}" atributo-detalles="${detallesProducto}"></a></li>` //agregando elemento a lista + link+ imagen+ titulo del producto hecho por el usuario + chulito
        contenedorListado.innerHTML += modelo
        document.addEventListener('click',function(e){
            if (e.target.className == "chulito"){                
                contenedorListado.style.display = 'none'
                ...
                contenedorDetalles.style.display = 'block' //Mostrando el contenedor de los detalles
                botonAdd.style.display = 'none'
                document.getElementById("imagen-detalles").src = "images/verduras.png"
                document.getElementById("h1-detalles").innerHTML = e.target.getAttribute("atributo-nombre")
                document.getElementById("p-detalles").innerHTML = e.target.getAttribute("atributo-detalles")
                document.getElementById('logo-cierre-detalles').addEventListener('click', function(){
                    contenedorDetalles.style.display = 'none'
    ...
    else if(tipoProducto.value == 4){ //comprobando el valor de la seleccion del tipo de producto
        let tituloProducto = `${nombreProducto.value}`
        let detallesProducto = `${descripcion.value}`
        let modelo = `<li class="list-group-item li-listado"><img src="images/electronica.png" alt="Viberes" id="logos"> <h4>${tituloProducto}</h4><a href="#" id="chulardi"><img src="images/chulardi.png" class="chulito" alt="Chulote" atributo-nombre="${tituloProducto}" atributo-detalles="${detallesProducto}"></a></li>` //agregando elemento a lista + link+ imagen+ titulo del producto hecho por el usuario + chulito
        contenedorListado.innerHTML += modelo
        document.addEventListener('click',function(e){
            if (e.target.className == "chulito"){                
                contenedorListado.style.display = 'none'
                ...
                contenedorDetalles.style.display = 'block' //Mostrando el contenedor de los detalles
                botonAdd.style.display = 'none'
                document.getElementById("imagen-detalles").src = "images/electronica.png"
                document.getElementById("h1-detalles").innerHTML = e.target.getAttribute("atributo-nombre")
                document.getElementById("p-detalles").innerHTML = e.target.getAttribute("atributo-detalles")
                document.getElementById('logo-cierre-detalles').addEventListener('click', function(){
                    contenedorDetalles.style.display = 'none'
